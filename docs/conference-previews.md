...
NEXT_PUBLIC_CONFERENCE_SCHEDULE_NOTE=Preliminary schedule: session times, tracks, and stages are provisional until WeAreDevelopers publishes the official agenda.
NEXT_PUBLIC_CONFERENCE_ID=wearedevelopers-world-congress-na-2026
NEXT_PUBLIC_SENTRY_ENVIRONMENT=wad-na-2026
...
NEXT_PUBLIC_CONFERENCE_TIME_ZONE=America/Los_Angeles
NEXT_PUBLIC_CONFERENCE_SCHEDULE_NOTE=Preliminary schedule: sessions, times, and tracks are illustrative until The AI Conference publishes its official agenda.
NEXT_PUBLIC_CONFERENCE_ID=the-ai-conference-2026
NEXT_PUBLIC_SENTRY_ENVIRONMENT=ai-conf-2026
